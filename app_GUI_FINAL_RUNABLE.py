...
#     output_text.clear()  # Clear the output text
#     output_text.penup()
#     output_text.goto(-window.window_width() / 2 + window.window_width() * 0.1, 0)  # 10% left margin padding
#     output_text.write(message, align="left", font=("Arial", 14, "normal"))
...
def start_virtual_assistant(x, y):
    ...
    while True:
        ...
        if query:
            ...
            # elif "camera" in query.lower() or "take a photo" in query.lower():
            #     ec.capture(0,"robo camera","img.jpg")
            #     print('Here is your photo')
            #     speak('Here is your photo')

            # elif 'ask' in query.lower():
