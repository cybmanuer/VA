...
start_text.penup()
start_text.goto(0, 0)
start_text.write("Start", align="center", font=("Arial", 10, "bold"))   

# Create the output text turtle
output_text = turtle.Turtle()
output_text.penup()
output_text.goto(0, 100)
...
stop_text.penup()
stop_text.goto(0, -100)
stop_text.color("black")
stop_text.write("Stop", align="center", font=("Arial", 10, "bold"))
